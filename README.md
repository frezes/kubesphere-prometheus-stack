...
```console
helm install kubesphere-prometheus-stack -n kubesphere-monitoring-system   -f custom-values.yaml .
```
...
```console
helm uninstall kubesphere-prometheus-stack
```
